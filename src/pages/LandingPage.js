        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <Link to="/signup" className="ml-4 px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md">
                Sign up
              </Link>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">Smart Task Management</span>
            <span className="block text-blue-600">for Teams</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Empower your team with seamless project and task management using Kanban boards, real-time updates, and intuitive UI/UX.
          </p>
            ...
            <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-5 text-center">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Kanban Boards</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Intuitive drag-and-drop interface for visual task management.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-5 text-center">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    See changes from team members instantly with WebSockets.
                  </p>
                </div>
              </div>
      ...
      <footer className="bg-gray-50">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <p className="text-center text-gray-500 text-sm">
            &copy; 2025 CollabEase. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
